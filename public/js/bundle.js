...
},{"./public/src/leaflet":20,"bootstrap":2,"geojson":15,"jquery":16,"leaflet":19,"leaflet-draw":17,"leaflet-easybutton":18}],2:[function(require,module,exports){
...
function addLayersFromKuzzle(objMock)
{
    ...
    L.control.layers(kuzzleLayers, null, {position: 'bottomright'}).addTo(this._map);
}
...
function drawFeatures()
{
    ...
    var drawnItems = new L.FeatureGroup(/*this._editableLayer*/);
...
exports.drawFeatures = drawFeatures;
